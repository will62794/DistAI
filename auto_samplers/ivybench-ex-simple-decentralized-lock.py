		...
		def collect_subsamples():
			...
			for k in range(3):
				...
				for N1, N2, N3, N4, in permutations(node_indices):
					df_data.add((message[N1,N1], message[N1,N2], message[N1,N3], message[N1,N4], message[N2,N1], message[N2,N2], message[N2,N3], message[N2,N4], message[N3,N1], message[N3,N2], message[N3,N3], message[N3,N4], message[N4,N1], message[N4,N2], message[N4,N3], message[N4,N4], has_lock[N1], has_lock[N2], has_lock[N3], has_lock[N4], start_node[0]==N1, start_node[0]==N2, start_node[0]==N3, start_node[0]==N4))
...
if __name__ == '__main__':
	...
	end_time = time.time()
	df.to_csv('../traces/ivybench-ex-simple-decentralized-lock.csv', index=False)
	print('Simulation finished. Trace written to traces/ivybench-ex-simple-decentralized-lock.csv')
